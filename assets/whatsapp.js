(function() {
    ...
    const WHATSAPP_NUMBER = '+254707011179';
    const WHATSAPP_MESSAGE = 'Hi! I\'d like to chat about your branding services.';
    ...
    function createWhatsAppButton() {
        ...
        button.href = `https://wa.me/${WHATSAPP_NUMBER.replace(/[^\d]/g, '')}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`;
    ...
    // Start the WhatsApp functionality
    initWhatsApp();
})();
